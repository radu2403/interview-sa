...
from comicbook.job.statistics.Bottom10VillainsByAppearancePerPublisherJob import Bottom10VillainsByAppearancePerPublisherJob
...
def test_that_the_job_is_created_with_success_with_parameters(stats_dao, dc_dao, marvel_dao, hero_ability_dao):
    # act
    Bottom10VillainsByAppearancePerPublisherJob(
...
def test_that_the_job_is_executed_and_return_10_values(stats_dao, dc_dao, marvel_dao):
    # assign
    job = Bottom10VillainsByAppearancePerPublisherJob(
        _stats_dao=stats_dao,
        _dc_dao=dc_dao,
        _marvel_dao=marvel_dao
    )
...
def test_that_the_job_mv_trans_return_name_and_appearance(marvel_dao):
    ...
    # act
    df = mv_df.transform(Bottom10VillainsByAppearancePerPublisherJob.marvel_transformation())
...
def test_that_the_job_mv_trans_return_name_and_appearance(dc_dao):
    ...
    # act
    df = dc_df.transform(Bottom10VillainsByAppearancePerPublisherJob.dc_transformation())
...
def test_that_the_job_stats_trans_return_name_without_parentheses(stats_dao):
    ...
    # act
    df = st_df.transform(Bottom10VillainsByAppearancePerPublisherJob.stats_transformation())
