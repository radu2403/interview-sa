...
from comicbook.job.statistics.Top10OverallScoreJob import Top10OverallScoreJob
...
def test_that_the_job_return_in_descending_order(stats_dao, hero_ability_dao):
    ...
    # assign
    assert df.collect()[0]["overall_score"] > df.collect()[1]["overall_score"]
